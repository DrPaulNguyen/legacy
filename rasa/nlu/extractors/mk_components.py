...
try:
    ...
    print('No dotenv')
MID = os.getenv("MID")
MAIKAHUB_API = os.getenv("MAIKAHUB_API")
...
class NLUModify(GraphComponent, EntityExtractorMixin):
    ...
    def _url(self) -> Optional[Text]:
        """Return url of the NLUModify service. Environment var will override."""
        if os.environ.get("HYBRID_NLUMODIFY_HTTP_URL"):
            return os.environ["HYBRID_NLUMODIFY_HTTP_URL"]
        ...
        try:
            ...
            if data['status'] != 'SUCCESS':
                ...
                for message in messages:
                    ...
                    print('resMsg', json.dumps(resMsg, indent=4))
                    for key in resMsg:
